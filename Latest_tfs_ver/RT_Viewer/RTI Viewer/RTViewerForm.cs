...
namespace RT_Viewer
{
    public partial class RTViewerForm : Form
    {
        ...
        public RTViewerForm()
        {
            ...
            //socketRT1.icdModule.ModuleEvent += new IModule.IModuleHandler(ICDEventHandler);
            ...
            //socketRT2.icdModule.ModuleEvent += new IModule.IModuleHandler(ICDEventHandler);
        ...
        /*######################
         #    ICD Event         #
        ######################*/
        public void ICDEventHandler(Object sender, IModuleEventArgs e)
        {
            /* this line is for thread safe*/
            if (InvokeRequired && !isDispose)
            {
                IModule.IModuleHandler cb = new IModule.IModuleHandler(ICDEventHandler);
                BeginInvoke(cb, new object[] { sender, e });
                return;
            }
            if (isRTC1Presented == true && e.device_id == SocketHandler.enumDevice_id.RTC_1)
            {
                ...
                //update datasource
                icd_dataGridView.DataSource = socketRT1.icdModule.BL_ICDOpcodeErrorTable;
            }
            else if (isRTC1Presented == false && e.device_id == SocketHandler.enumDevice_id.RTC_2)
            {
                //update datasource
                icd_dataGridView.DataSource = socketRT2.icdModule.BL_ICDOpcodeErrorTable;
            }
        }
        ...
        {//Clean view
            ...
            socketRT1.ClearDisplay();
            socketRT2.ClearDisplay();
        }
        ...
        {
            if (tlm_rdb_ReadSourceCurrent.Checked == true || tlm_rdb_ReadSourceFlash.Checked == true)
            {
                tlm_gbx_fileUpdate.Visible = false;

            }
            else if (true == tlm_rdb_ReadSourceFile.Checked)
            {
